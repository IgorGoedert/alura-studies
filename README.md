...
Curso voltado para quem está iniciando na área de tecnologia, abordando fundamentos da programação e direcionamento de carreira.
- Conceitos iniciais sobre lógica e programação
- Como funciona o mercado de tecnologia
- Principais áreas de atuação em desenvolvimento
- Boas práticas para iniciar na carreira tech
...
- Consultas com SELECT para recuperação de dados
...
- Conceitos fundamentais de banco de dados relacionais
...
- Estrutura e tipos de dados no SQLite
- Organização e modelagem básica de dados
